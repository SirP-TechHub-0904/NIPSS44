...
namespace NIPSS44.Areas.Admin.Pages.ProfileAccount
{
    ...
    public class MailerModel : PageModel
    {
        ...
        public MailerModel(NIPSS44.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;
