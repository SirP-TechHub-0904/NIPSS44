...
namespace NIPSS44.Areas.Admin.Pages.ProfileAccount
{
    public class SendMailModel : PageModel
    {
        ...
        public SendMailModel(NIPSS44.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;
