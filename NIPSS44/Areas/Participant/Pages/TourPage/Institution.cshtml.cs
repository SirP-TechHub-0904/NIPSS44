...
namespace NIPSS44.Areas.Participant.Pages.TourPage
{
    public class InstitutionModel : PageModel
    {
        ...
        public InstitutionModel(NIPSS44.Data.NIPSSDbContext context, UserManager<IdentityUser> userManager, IHostingEnvironment hostingEnv)
        {
            _context = context;
